...
async function GetAllBookActivity() {
  ...
  let res = await fetch(`${apiUrl}/BookActivity`, requestOptions)
...
async function GetBookActivityById(id: Number | undefined) {
  ...
  let res = await fetch(`${apiUrl}/BookActivity/byId/${id}`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function DeleteBookActivityByID(id: Number | undefined) {
  ...
  let res = await fetch(`${apiUrl}/BookActivity/${id}`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
