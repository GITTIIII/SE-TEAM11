...
async function GetAllActivity() {
	...
	let res = await fetch(`${apiUrl}/Activity`, requestOptions)
...
async function GetActivityById(id: Number | undefined) {
	...
	let res = await fetch(`${apiUrl}/Activity/byId/${id}`, requestOptions)
		.then((response) => response.json())
		.then((res) => {
			if (res.data) {
				return res.data;
...
async function DeleteActivityByID(id: Number | undefined) {
	...
	let res = await fetch(`${apiUrl}/Activity/${id}`, requestOptions)
		.then((response) => response.json())
		.then((res) => {
			if (res.data) {
				return res.data;
...
export { GetAllActivity, GetActivityById, CreateActivity, DeleteActivityByID, UpdateActivity };
