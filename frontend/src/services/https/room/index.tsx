...
async function GetRoomById(id: Number | undefined) {
	...
	let res = await fetch(`${apiUrl}/Room/byId/${id}`, requestOptions)
		.then((response) => response.json())
		.then((res) => {
			if (res.data) {
				return res.data;
...
async function DeleteRoomByID(id: Number | undefined) {
	const requestOptions = {
		method: "DELETE",
	};
...
export { GetAllRoom, GetRoomById, CreateRoom, DeleteRoomByID, UpdateRoom, ListRoom };
